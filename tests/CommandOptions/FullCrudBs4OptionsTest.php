    ...
    <div class=\"col-md-6\">
        ...
        @can('delete', \${$this->single_model_var_name})
            <div class=\"card\">
                ...
                <div class=\"card-footer\">
                    <form method=\"POST\" action=\"{{ route('{$this->table_name}.destroy', \${$this->single_model_var_name}) }}\" accept-charset=\"UTF-8\" onsubmit=\"return confirm(&quot;{{ __('{$this->lang_name}.delete_confirm') }}&quot;)\" class=\"del-form float-right\" style=\"display: inline;\">
