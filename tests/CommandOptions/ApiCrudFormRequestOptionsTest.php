...
class ApiCrudFormRequestOptionsTest extends TestCase
{
    /** @test */
    public function it_can_generate_form_request_classes()
    {
        $this->artisan('make:crud-api', ['name' => $this->model_name, '--no-interaction' => true, '--form-requests' => true]);
        ...
        $this->assertFileDoesNotExist(resource_path("views/{$this->table_name}/create.blade.php"));
        $this->assertFileDoesNotExist(resource_path("views/{$this->table_name}/edit.blade.php"));
