    ...
    <div class=\"col-md-6 col-md-offset-3\">
        ...
        @can('delete', \${$this->single_model_var_name})
            <div class=\"panel panel-default\">
                ...
                <div class=\"panel-footer\">
                    <form method=\"POST\" action=\"{{ route('{$this->table_name}.destroy', \${$this->single_model_var_name}) }}\" accept-charset=\"UTF-8\" onsubmit=\"return confirm(&quot;{{ __('{$this->lang_name}.delete_confirm') }}&quot;)\" class=\"del-form pull-right\" style=\"display: inline;\">
