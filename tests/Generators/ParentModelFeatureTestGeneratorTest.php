...
class Manage{$this->model_name}Test extends TestCase
{
    ...
    public function user_can_create_a_{$this->lang_name}()
    {
        ...
        \$this->seeRouteIs('{$this->parent_table_name}.{$this->table_name}.create', \${$this->single_parent_model_var_name});

        \$this->submitForm(__('app.create'), \$this->getCreateFields());

        \$this->seeRouteIs('{$this->parent_table_name}.{$this->table_name}.show', [\${$this->single_parent_model_var_name}, {$this->model_name}::first()]);
    ...
    public function user_can_edit_a_{$this->lang_name}()
    {
        ...
        \$this->visitRoute('{$this->parent_table_name}.{$this->table_name}.show', [\${$this->single_parent_model_var_name}, \${$this->single_model_var_name}]);
        \$this->click('edit-{$this->lang_name}-'.\${$this->single_model_var_name}->id);
        \$this->seeRouteIs('{$this->parent_table_name}.{$this->table_name}.edit', [\${$this->single_parent_model_var_name}, \${$this->single_model_var_name}]);

        \$this->submitForm(__('{$this->lang_name}.update'), \$this->getEditFields());

        \$this->seeRouteIs('{$this->parent_table_name}.{$this->table_name}.show', [\${$this->single_parent_model_var_name}, \${$this->single_model_var_name}]);
    ...
    public function user_can_delete_a_{$this->lang_name}()
    {
        ...
        \$this->visitRoute('{$this->parent_table_name}.{$this->table_name}.edit', [\${$this->single_parent_model_var_name}, \${$this->single_model_var_name}]);
        \$this->click('del-{$this->lang_name}-'.\${$this->single_model_var_name}->id);
        \$this->seeRouteIs('{$this->parent_table_name}.{$this->table_name}.edit', [\${$this->single_parent_model_var_name}, \${$this->single_model_var_name}, 'action' => 'delete']);
