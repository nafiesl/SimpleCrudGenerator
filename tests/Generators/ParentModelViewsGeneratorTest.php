...
class ParentModelViewsGeneratorTest extends TestCase
{
    /** @test */
    public function it_creates_correct_index_view_content()
    {
        ...
        $indexViewPath = resource_path("views/{$this->parent_table_name}/{$this->table_name}/index.blade.php");
...
<div class=\"mb-3\">
    <div class=\"float-end\">
        @can('create', new {$this->full_model_name})
            <a href=\"{{ route('{$this->parent_table_name}.{$this->table_name}.create', \${$this->single_parent_model_var_name}) }}\" class=\"btn btn-success\">{{ __('{$this->lang_name}.create') }}</a>
        @endcan
    </div>
                ...
                <form method=\"GET\" action=\"\" accept-charset=\"UTF-8\">
                    <div class=\"row g-2\">
                        ...
                        <div class=\"col-auto\">
                            ...
                            <a href=\"{{ route('{$this->parent_table_name}.{$this->table_name}.index', \${$this->single_parent_model_var_name}) }}\" class=\"btn btn-link\">{{ __('app.reset') }}</a>
                        </div>
                    </div>
                </form>
            </div>
                    ...
                    <tr>
                        ...
                        <td class=\"text-center\">
                            @can('view', \${$this->single_model_var_name})
                                <a href=\"{{ route('{$this->parent_table_name}.{$this->table_name}.show', [\${$this->single_parent_model_var_name}, \${$this->single_model_var_name}]) }}\" id=\"show-{$this->lang_name}-{{ \${$this->single_model_var_name}->id }}\">{{ __('app.show') }}</a>
                            @endcan
                        </td>
                    </tr>
                    @endforeach
...
";
    ...
    public function it_creates_correct_show_view_content()
    {
        ...
        $showFormViewPath = resource_path("views/{$this->parent_table_name}/{$this->table_name}/show.blade.php");
        ...
        <div class=\"card\">
            ...
            <div class=\"card-footer\">
                @can('update', \${$this->single_model_var_name})
                    <a href=\"{{ route('{$this->parent_table_name}.{$this->table_name}.edit', [\${$this->single_parent_model_var_name}, \${$this->single_model_var_name}]) }}\" id=\"edit-{$this->lang_name}-{{ \${$this->single_model_var_name}->id }}\" class=\"btn btn-warning\">{{ __('{$this->lang_name}.edit') }}</a>
                @endcan
                <a href=\"{{ route('{$this->parent_table_name}.{$this->table_name}.index', \${$this->single_parent_model_var_name}) }}\" class=\"btn btn-link\">{{ __('{$this->lang_name}.back_to_index') }}</a>
            </div>
        </div>
    </div>
</div>
...
";
    ...
    public function it_creates_correct_create_view_content()
    {
        ...
        $createFormViewPath = resource_path("views/{$this->parent_table_name}/{$this->table_name}/create.blade.php");
...
<div class=\"row justify-content-center\">
    <div class=\"col-md-6\">
        <div class=\"card\">
            ...
            <form method=\"POST\" action=\"{{ route('{$this->parent_table_name}.{$this->table_name}.store', \${$this->single_parent_model_var_name}) }}\" accept-charset=\"UTF-8\">
                {{ csrf_field() }}
                <div class=\"card-body\">
                    <div class=\"mb-3\">
                ...
                <div class=\"card-footer\">
                    ...
                    <a href=\"{{ route('{$this->parent_table_name}.{$this->table_name}.index', \${$this->single_parent_model_var_name}) }}\" class=\"btn btn-link\">{{ __('app.cancel') }}</a>
                </div>
            </form>
        </div>
    </div>
...
";
    ...
    public function it_creates_correct_edit_view_content()
    {
        ...
        $editFormViewPath = resource_path("views/{$this->parent_table_name}/{$this->table_name}/edit.blade.php");
    ...
    <div class=\"col-md-6\">
        ...
        @can('delete', \${$this->single_model_var_name})
            <div class=\"card\">
                ...
                <div class=\"card-footer\">
                    <form method=\"POST\" action=\"{{ route('{$this->parent_table_name}.{$this->table_name}.destroy', [\${$this->single_parent_model_var_name}, \${$this->single_model_var_name}]) }}\" accept-charset=\"UTF-8\" onsubmit=\"return confirm(&quot;{{ __('{$this->lang_name}.delete_confirm') }}&quot;)\" class=\"del-form float-end\" style=\"display: inline;\">
                        {{ csrf_field() }} {{ method_field('delete') }}
                        <input name=\"{$this->lang_name}_id\" type=\"hidden\" value=\"{{ \${$this->single_model_var_name}->id }}\">
                        <button type=\"submit\" class=\"btn btn-danger\">{{ __('app.delete_confirm_button') }}</button>
                    </form>
                    <a href=\"{{ route('{$this->parent_table_name}.{$this->table_name}.edit', [\${$this->single_parent_model_var_name}, \${$this->single_model_var_name}]) }}\" class=\"btn btn-link\">{{ __('app.cancel') }}</a>
                </div>
            </div>
        @endcan
        @else
        <div class=\"card\">
            ...
            <form method=\"POST\" action=\"{{ route('{$this->parent_table_name}.{$this->table_name}.update', [\${$this->single_parent_model_var_name}, \${$this->single_model_var_name}]) }}\" accept-charset=\"UTF-8\">
                ...
                <div class=\"card-footer\">
                    ...
                    <a href=\"{{ route('{$this->parent_table_name}.{$this->table_name}.show', [\${$this->single_parent_model_var_name}, \${$this->single_model_var_name}]) }}\" class=\"btn btn-link\">{{ __('app.cancel') }}</a>
                    @can('delete', \${$this->single_model_var_name})
                        <a href=\"{{ route('{$this->parent_table_name}.{$this->table_name}.edit', [\${$this->single_parent_model_var_name}, \${$this->single_model_var_name}, 'action' => 'delete']) }}\" id=\"del-{$this->lang_name}-{{ \${$this->single_model_var_name}->id }}\" class=\"btn btn-danger float-end\">{{ __('app.delete') }}</a>
                    @endcan
                </div>
            </form>
        </div>
